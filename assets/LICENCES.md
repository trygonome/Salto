...
| Pictogrammes du HUD et du sac (`ui/icons/pause.svg`, `drum*.svg`, `item_*.svg`) et thème de l'interface (`ui/theme.tres`) | Salto | créés pour le projet | propriété du projet | `assets/ui` | sans objet (interface) |
...
| Éléments de jeu hors monde voxel : tambours et leur estrade, gongs, coffres, champignon, butin (formes simples) | Salto | créés pour le projet | propriété du projet | `scenes/levels/props` | oui : gongs de 2 m, coffre de 0,7 m, champignon de 1,3 m, tambours de 0,65 m (0,5 m à l’échelle 1,3) |
| Monde voxel, villageois et ombres rondes (`scripts/world`, `scenes/world`) : génération du monde, couleurs, sol, ciel et personnages portés du prototype `docs/prototype/salto-rpg.html` | Salto | créés pour le projet | propriété du projet | `scripts/world`, `scenes/world` | oui : 1 u = 0,26 m ; villageois de 1,8 m (Chef 2,2 m), comme le héros |
